...
<head>
    ...
    <title>Students notes Management System |  Downloaded Notes/Books</title>
...
<?php $sql = "SELECT tblbooks.BookName,tblcategory.CategoryName,tblbooks.id as bookid,tblbooks.bookImage,tblbooks.bookpdf,  
...
{               ?>  
  ...
  <table class="table table-bordered">
    ...
    <tr>    <td colspan="3"><a href="admin/bookpdf/<?php echo htmlentities($result->bookpdf);?>"><button type="button"  class="btn btn-success">Download</button></a></td>
