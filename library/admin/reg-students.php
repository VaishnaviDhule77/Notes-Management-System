...
if(strlen($_SESSION['alogin'])==0) {   
    ...
    // NEW FEATURE: Code for deleting student
    if(isset($_GET['del'])) {
        $id=$_GET['del'];
...
<head>
    ...
    <title>Student Notes Management System | Manage Reg Students</title>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <?php if($result->Status==1) { ?>
                                                            <a href="reg-students.php?inid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to block this student?');">
                                                                <button class="btn btn-warning btn-xs"> Block</button>
                                                            </a>
                                                        <?php } else { ?>
                                                        ...
                                                        <!-- NEW: Delete Action -->
                                                        <a href="reg-students.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this student? This action cannot be undone.');">
