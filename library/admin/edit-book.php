...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Book/Notes</h4>
...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT tblbooks.BookName,tblcategory.CategoryName,tblcategory.id as cid,tblbooks.id as bookid,tblbooks.bookImage,tblbooks.bookpdf from  tblbooks join tblcategory on tblcategory.id=tblbooks.CatId where tblbooks.id=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
...
<!-- <img src="bookpdf/<?php echo htmlentities($result->bookpdf);?>" width="100"> -->
<a href="change-bookpdf.php?bookid=<?php echo htmlentities($result->bookid);?>">Change Book PDF</a>
</div></div>
<div class="col-md-6">
<div class="form-group">
